...
int g_iGAgentPrintFlag = 1;

void GAgent_DebugEnable(void)
{
    g_iGAgentPrintFlag = 0;
    return;
}

void GAgent_DebugDisable(void)
{
    g_iGAgentPrintFlag = 1;
    return;
}
...
void GAgent_Printf(unsigned char level, char *fmt, ...)
{
    ...
    switch(level)
    {
        ...
        case GAGENT_DEBUG:
            ...
            buffer = str + i;
            break;
        case GAGENT_PACKETDUMP:
            i = 0;
            buffer = str;
            break;
        case GAGENT_DEBUG_PACKET:
            i = 9;
            memcpy(str,"\r\nPACKET ", i);
            buffer = str + i;
            break;            
