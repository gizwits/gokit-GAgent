...
#define MQTT_QOS0_FLAG    (0<<MQTT_QOS_SHIFT)   /* QoS=0：最多一次，有可能重复或丢失 */
#define MQTT_QOS1_FLAG    (1<<MQTT_QOS_SHIFT)   /* QoS=1：至少一次，有可能重复 */
#define MQTT_QOS2_FLAG    (2<<MQTT_QOS_SHIFT)   /* QoS=2：只有一次，确保消息只到达一次 */
